            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
					...
					<li class="<?php echo activate_menu('profil') ?>">
						...
						<ul>
                            <li class="<?php echo activate_menu('profil','sambutan') ?>"><a href="<?php echo base_url('index.php/admin/profil/sambutan'); ?>"><span class="fa fa-bullhorn"></span> Sambutan</a></li>
