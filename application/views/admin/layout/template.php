...
<html lang="en">
    <head>        
		...
		<link rel="stylesheet" type="text/css" id="theme" href="<?php echo base_url(); ?>assets/backend/css/theme-serenity.css"/>
		<style>
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><marquee width="1200px auto">Badan Eksekutif Mahasiswa (BEM) STT Wastukancana Purwakarta</marquee></li>
                </ul>
                <!-- END BREADCRUMB -->                
