...
class Home extends CI_Controller{
	...
	function index(){			
		...
		$data['sambutan']	= $this->profil_model->sambutan_home();		
		$data['title'] 		= "BEM STT Wastukancana Purwakarta";
	...
	function artikel(){				
		...
		$data['archive']	= $this->artikel_model->archive();
		$data['archive2']	= $this->artikel_model->archive2();
		$data['profil']		= $this->profil_model->lihat();				
		$data['title'] 		= "Blog STT Wastukancana Purwakarta";
	...
	function tentang(){
		$data['profil']		= $this->profil_model->lihat();		
		$data['title'] 		= "Tentang BEM STT Wastukancana Purwakarta";
